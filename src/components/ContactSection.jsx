...
const ContactSection = () => {
  return (
    <section id="contact">
      <div className="sm:py-8 lg:py-16 sm:w-[90%] lg:w-[80%] mx-auto flex items-center sm:flex-col lg:flex-row mt-5 mb-16 rounded-lg bg-gradient-to-r from-emerald-500 to-sky-500 px-8 text-gray-900">
